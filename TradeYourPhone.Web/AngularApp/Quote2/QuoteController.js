tradeYourPhoneControllers.controller('QuoteCtrl1', function ($scope, QuoteService, PhoneModelService, $location, $cookies, $q, $anchorScroll, $analytics, $timeout, $window, phoneModels, phoneConditions, quote) {
